...
import { DataTablePagination, DataTableToolbar, getColumnPinningStyle } from "../shared"

interface DataTableClientProps<TData> extends React.ComponentProps<"div"> {
...
export function DataTableClient<TData>({
  ...
  return (
    <div className={cn("flex w-full flex-col gap-2.5 overflow-auto", className)} {...props}>
      <DataTableToolbar table={table} batchActions={batchActions} />
