  ...
  return (
    ...
    >
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger render={<Button dir={dir} variant="outline" size="sm" className="font-normal" onKeyDown={onTriggerKeyDown} disabled={disabled} />}><ArrowDownUp className="text-muted-foreground" />Sort
                          {sorting.length > 0 && (
                            <Badge
                              variant="secondary"
