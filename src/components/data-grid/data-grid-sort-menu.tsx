...
export function DataGridSortMenu<TData>({ table, disabled, ...props }: DataGridSortMenuProps<TData>) {
  ...
  return (
    ...
    >
      <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
        ...
        <PopoverContent id={fieldListboxId} dir={dir} className="w-(--radix-popover-trigger-width) p-0">
          <Command>
